...
import { DataBrowserTableView } from "../components/DataBrowserTableView";
import { DataBrowserJsonView } from "../components/DataBrowserJsonView";
          ...
          <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
            {viewMode === "table" && (
              <DataBrowserTableView
                ...
                onEditRow={openEdit}
                onDeleteRow={(index, id) => handleDeleteDoc(index, id)}
